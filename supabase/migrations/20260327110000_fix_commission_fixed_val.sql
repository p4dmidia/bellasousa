-- Fix Commission Logic: Fixed Valor for MMN, Percentage for Leadership
-- This update ensures that if commission_type = 'fixed' in site_configs, 
-- MMN levels are paid as R$ values instead of percentages.
